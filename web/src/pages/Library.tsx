...
const doors = (s: Stats | null) => [
  { ico: '🩺', title: 'Conditions & uses', count: s ? fmtCompact(s.therapeutic_uses) : '…', desc: "Don't know what to ask? Browse by ailment — fever, cough, inflammation — to the plants linked to it.", to: '/conditions' },
